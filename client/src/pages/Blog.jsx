  ...
  return data ? (
    <div className='relative min-h-screen'>
      ...
      <div className='text-center mt-20 text-gray-800'>
        <p className='text-purple-700 font-semibold'>Published on {formatDate(data.createdAt)}</p>
        ...
        <p className='inline-block bg-purple-100 text-purple-700 py-2 px-4 rounded-full'>By Abhinav Singh</p>
      </div>
