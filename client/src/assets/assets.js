...
export const blog_data = [
    ...
    {
  "_id": "6812b5d1f3a2e948d9a5c4f1",
  "title": "How Smart Training Can Boost Your Sports Performance",
  "description": "<h1>How Smart Training Can Boost Your Sports Performance</h1><p>Great athletic progress is not only about hard work—it's about training smarter.</p><h2>1. <strong>Focus on Recovery</strong></h2><p>Rest, sleep, and mobility work help your body adapt faster and avoid injury.</p><h2>2. <strong>Build Strength with Purpose</strong></h2><p>Strength training should support your sport, whether it's speed, power, or endurance.</p><h2>3. <strong>Practice Consistency</strong></h2><p>Small daily improvements add up. Stick to a plan instead of chasing dramatic changes.</p><h2>4. <strong>Train Your Mind</strong></h2><p>Mental preparation, visualization, and confidence are as important as physical practice.</p><h2>5. <strong>Eat and Hydrate for Performance</strong></h2><p>Fuel your body with balanced meals and proper hydration to stay sharp during training and competition.</p>",
  "category": "Sports",
  "image": blog_pic_10,
  ...
  "__v": 0,
  "isPublished": true,
  "subTitle": "Train smarter, recover better, and perform at your best"
},
    {
